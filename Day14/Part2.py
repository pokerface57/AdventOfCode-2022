...
def sand_fall(board, bottom):
    ...
    x_grain = 500
    grain_count = 0
    while board[0][500] not in block_elements:
...
draw_board(board, 0, depth, 325, width)

print()
print('-' * 1900)
print()
finish_board, result = sand_fall(board, bottom)
draw_board(finish_board, 0, depth, 325, width)
print()
print(f'Units of sand come to rest: {result}')
